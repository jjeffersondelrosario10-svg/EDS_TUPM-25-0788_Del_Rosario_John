...
```
EDS_TUPM-25-0788_DelRosario/
├── main.py                  ← Full OOP pipeline
├── requirements.txt
├── README.md
├── data/
│   ├── T1.csv               ← Download from Kaggle
│   └── dataset_cleaned.csv  ← Auto-generated by pipeline
└── outputs/
...
## Key Results
- Clean records (after filter): 191
- r(Wind Speed, LV Power): 0.885
- Mean Capacity Factor: 16.52%
- Mean Power Deviation: -24.91 kW
- Outliers detected (IQR): 29 (15.18%)
